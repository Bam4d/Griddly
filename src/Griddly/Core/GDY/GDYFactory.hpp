...
class GDYFactory {
 public:
  ...
  virtual std::shared_ptr<Observer> createObserver(std::shared_ptr<Grid> grid, std::string observerName, std::vector<std::shared_ptr<Player>> players, uint32_t playerId = 0);
