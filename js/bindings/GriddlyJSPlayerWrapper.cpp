...
e::val GriddlyJSPlayerWrapper::stepSingle(std::string actionName, std::vector<int32_t> actionArray, bool updateTicks) {
...
e::val GriddlyJSPlayerWrapper::buildInfo(griddly::ActionResult actionResult) {
...
std::shared_ptr<griddly::Action> GriddlyJSPlayerWrapper::buildAction(std::string actionName, std::vector<int32_t> actionArray) {
