...
if __name__ == "__main__":
    ...
    config = {
        ...
        "callbacks": MultiCallbacks([ActionTrackerCallbacks, VideoCallbacks]),
        "model": {"custom_model": "ImpalaCNN", "custom_model_config": {}},
        "env": env_name,
        "env_config": {
        ...
        "entropy_coeff_schedule": [[0, 0.001], [max_training_steps, 0.0]],
