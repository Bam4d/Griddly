...
def test_partial_observability_0_2(test_name):
    ...
    """
    env = build_test_env(test_name, "tests/gdy/partial_observability_0_1.yaml", global_observer_type="TestVectorObserver", player_observer_type=["TestASCIIObserver", "TestVectorObserver"])
