...
def test_step_SinglePlayer_SelectSource_MultipleActionType_MultipleAction(test_name):
    ...
    obs, reward, done, info = env.step([[2, 3, 0, 1], [1, 4, 0, 1]])
    ...
    obs, reward, done, info = env.step([[1, 3, 1, 3], [0, 4, 1, 3]])
...
def test_step_MultiplePlayer_MultipleActionType(test_name):
    ...
    obs, reward, done, info = env.step([[0, 1], [1, 3],])
...
def test_step_MultiplePlayer_SelectSource_SingleActionType(test_name):
    ...
    obs, reward, done, info = env.step([[1, 3, 1], [3, 3, 3],])
...
def test_step_MultiplePlayer_SelectSource_MultipleActionType(test_name):
    ...
    obs, reward, done, info = env.step([[1, 3, 0, 1], [3, 3, 1, 3],])
...
def test_step_MultiplePlayer_SelectSource_SingleActionType_MultipleAction(test_name):
    ...
    obs, reward, done, info = env.step([[[1, 3, 1], [3, 4, 3],], [[3, 3, 1],],])
...
def test_step_MultiplePlayer_SingleActionType_SingleValue_Agent_DONE(test_name):
    ...
    obs, reward, done, info = env.step([1, None,])
...
def test_step_MultiplePlayer_MultipleActionType_Agent_DONE(test_name):
    ...
    obs, reward, done, info = env.step([[0, 1], None,])
...
def test_step_MultiplePlayer_SelectSource_SingleActionType_Agent_DONE(test_name):
    ...
    obs, reward, done, info = env.step([[1, 3, 1], None,])
...
def test_step_MultiplePlayer_SelectSource_MultipleActionType_Agent_DONE(test_name):
    ...
    obs, reward, done, info = env.step([[1, 3, 0, 1], None,])
...
def test_step_MultiplePlayer_SelectSource_SingleActionType_MultipleAction_Agent_DONE(
    test_name,
):
    """
    There no avatar, multiple players
    ...
    obs, reward, done, info = env.step([[[1, 3, 1], [3, 4, 3],], None,])
...
def test_step_MultiplePlayer_SelectSource_MultipleActionType_MultipleAction_Agent_DONE(
    test_name,
):
    """
    There no avatar, multiple players
    ...
    obs, reward, done, info = env.step([[[1, 3, 0, 1], [3, 4, 1, 3],], None,])
