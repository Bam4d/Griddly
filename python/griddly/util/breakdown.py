...
class TemporaryEnvironment:
    ...
    def __init__(
        ...
        gdy_string: str,
        observer_type_or_string: Union[gd.ObserverType, str],
    ) -> None:
        self.gdy = loader.load_string(gdy_string)
        self.observer_type = self._get_observer_type(observer_type_or_string)
        self.observer_name = self._get_observer_name(observer_type_or_string)
...
class EnvironmentBreakdown:
    def __init__(self, gdy_filename: str) -> None:
        """
    ...
    def _env(
        ...
        return TemporaryEnvironment(
            self.loader, self.gdy_string, observer_type_or_string
        )
