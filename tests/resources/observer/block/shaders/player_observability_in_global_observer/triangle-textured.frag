...
bool isInPlayerView(){
  ...
  for(int i=0;i<4;i++){
    ...
    vec4 right_bottom=vec4(playerInfoBuffer.variables[i].playerObservableGrid[3]+1,playerInfoBuffer.variables[i].playerObservableGrid[1]+1.0,0,0);
